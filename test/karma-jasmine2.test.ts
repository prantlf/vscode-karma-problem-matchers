...
describe('karma-jasmine2-progress-chrome problemMatcher', () => {
  const matcherName = 'karma-jasmine2-progress-chrome'
  ...
  describe('given karma-jasmine2-progress-chrome output with a failure', () => {
  ...
  describe('given karma-jasmine2-progress-chrome output with no failures', () => {
