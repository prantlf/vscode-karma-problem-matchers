...
describe('karma-jasmine-progress problemMatcher', () => {
  const matcherName = 'karma-jasmine-progress'
  ...
  describe('given karma-jasmine-progress output with a failure', () => {
  ...
  describe('given karma-jasmine-progress output with no failures', () => {
